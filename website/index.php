			...
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-12 text-center">
						<h1>#Eventr'15</h1>
						<p class="lead">Sed condimentum tempus auctor. Etiam euismod dapibus odio eu congue.<br>Maecenas eros lacus, tempus et pulvinar ac, commodo eget lacus. Curabitur ex non mi suscipit varius.<br>Phasellus ante lorem, sollicitudin quis erat sit
							amet, ultrices purus.</p>
						</div>
